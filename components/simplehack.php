    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: left;">
        ...
        <div style="text-align: center; padding: 40px 20px;">
            <div
                ...
                <div style="position: relative; z-index: 2;">
                    <h3 style="margin-bottom: 10px; font-size: 1.2rem;">XSS Cross Site
                        <Script></Script>
                    </h3>
                    <p style="font-size: 0.9rem; color: #e0e0e0;"><i>learning about CSS</i>
                    </p>
                    <a href="simple/xss.php"
                        style="display: inline-block; padding: 5px 10px; margin-top: 10px; color: #fff; text-decoration: none; border: 2px solid transparent; border-image: linear-gradient(90deg, rgb(52, 52, 52), rgb(103, 103, 103), rgb(65, 65, 65)); border-radius: 20px; border-image-slice: 1;">Learn
                        More</a>
                </div>
            </div>
        ...
        <div style="text-align: center; padding: 40px 20px;">
            <div
                ...
                <div style="position: relative; z-index: 2;">
                    <h3 style="margin-bottom: 10px; font-size: 1.2rem;">Dig IN Folders</h3>
                    <p style="font-size: 0.9rem; color:rgb(163, 163, 163);">
                    </p>
                    <a href="simple/find.php"
                        style="display: inline-block; padding: 5px 10px; margin-top: 10px; color: #fff; text-decoration: none; border: 2px solid transparent; border-image: linear-gradient(90deg, rgb(52, 52, 52), rgb(103, 103, 103), rgb(65, 65, 65)); border-radius: 20px; border-image-slice: 1;">Learn
                        More</a>
                </div>
            </div>
        ...
        <div style="text-align: center; padding: 40px 20px;">
            <div
                style="position: relative; background: url('../images/lock9.jpg') center/cover; border-radius: 10px; padding: 20px; width: 300px; height: 200px; text-align: center; color: #fff; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3); overflow: hidden;">
                <div
                    style="content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5); z-index: 1; border-radius: 10px;">
                </div>
                <div style="position: relative; z-index: 2;">
                    <h3 style="margin-bottom: 10px; font-size: 1.2rem;">Binary</h3>
                    <p style="font-size: 0.9rem; color:rgb(163, 163, 163);">
                    </p>
                    <a href="simple/binary.php"
                        style="display: inline-block; padding: 5px 10px; margin-top: 10px; color: #fff; text-decoration: none; border: 2px solid transparent; border-image: linear-gradient(90deg, rgb(52, 52, 52), rgb(103, 103, 103), rgb(65, 65, 65)); border-radius: 20px; border-image-slice: 1;">Learn
                        More</a>
                </div>
            </div>
        ...
        <div style="text-align: center; padding: 40px 20px;">
            <div
                ...
                <div style="position: relative; z-index: 2;">
                    <h3 style="margin-bottom: 10px; font-size: 1.2rem;">Morse Code</h3>
                    <p style="font-size: 0.9rem; color:rgb(163, 163, 163);">
                    </p>
                    <a href="simple/morse.php"
                        style="display: inline-block; padding: 5px 10px; margin-top: 10px; color: #fff; text-decoration: none; border: 2px solid transparent; border-image: linear-gradient(90deg, rgb(52, 52, 52), rgb(103, 103, 103), rgb(65, 65, 65)); border-radius: 20px; border-image-slice: 1;">Learn
                        More</a>
                </div>
            </div>
        ...
        <div style="text-align: center; padding: 40px 20px;">
            <div
                style="position: relative; background: url('../images/lock13.jpg') center/cover; border-radius: 10px; padding: 20px; width: 300px; height: 200px; text-align: center; color: #fff; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3); overflow: hidden;">
                <div
                    style="content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5); z-index: 1; border-radius: 10px;">
                </div>
                <div style="position: relative; z-index: 2;">
                    <h3 style="margin-bottom: 10px; font-size: 1.2rem;">BruteForcing</h3>
                    <p style="font-size: 0.9rem; color:rgb(163, 163, 163);">
                    </p>
                    <a href="simple/bruteforce.php"
                        style="display: inline-block; padding: 5px 10px; margin-top: 10px; color: #fff; text-decoration: none; border: 2px solid transparent; border-image: linear-gradient(90deg, rgb(52, 52, 52), rgb(103, 103, 103), rgb(65, 65, 65)); border-radius: 20px; border-image-slice: 1;">Learn
                        More</a>
                </div>
            </div>
