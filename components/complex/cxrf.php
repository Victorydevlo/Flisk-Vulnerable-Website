...
<body>
    ...
    <div class="header">
        <div class="title">Cross Site Request Forgery</div>
    </div>
    <div class="task">
        ...
        <div class="task-content" id="content1">
            <p>Welcome to the CSRF challenge! This task is designed to test your understanding of Cross-Site Request Forgery (CSRF) attacks. Your goal is to exploit a CSRF vulnerability on the test website. Remember, this is a learning exercise, so take your time and analyze the scenario carefully.</p>
