...
<body>
    ...
    <div class="header">
        <div class="title">Diggin through Folders</div>
    </div>
    ...
    <div class="task">
        ...
        <div class="task-content" id="content1">
            <p>In this task, you will need to use your skills in your ability to uncover hidden elements within files. Carefully analyze the provided image and apply your knowledge to extract the hidden flag.</p>
        </div>
    </div>
